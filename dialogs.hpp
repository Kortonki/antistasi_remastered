...
class AI_management
{
	...
	class controls
	{
AS_DIALOG(4,"AI Management","closeDialog 0; if (player == AS_commander) then {createDialog ""radio_comm_commander""} else {createDialog ""radio_comm_player""};");
...
class HQ_fort_dialog // 440
{
	...
	class controls
	{
    AS_DIALOG(4,"HQ Fortifications","closeDialog 0; createDialog ""radio_comm_commander"";");

	#define STR_HQ_CMO "closeDialog 0; [""net"", player] remoteExec [""AS_fnc_HQaddObject"",2];"
	#define STR_HQ_LAN "closeDialog 0; [""lantern"", player] remoteExec [""AS_fnc_HQaddObject"",2];"
	#define STR_HQ_SND "closeDialog 0; [""sandbag"", player] remoteExec [""AS_fnc_HQaddObject"",2];"
	#define STR_HQ_PAD "closeDialog 0; [""pad"", player] remoteExec [""AS_fnc_HQaddObject"",2];"
	#define STR_HQ_DEL "closeDialog 0; [""delete"", player] remoteExec [""AS_fnc_HQaddObject"",2];"
	#define STR_HQ_SB "closeDialog 0; [""small_bunker"", player] remoteExec [""AS_fnc_HQaddObject"",2];"
	#define STR_HQ_BB "closeDialog 0; [""big_bunker"", player] remoteExec [""AS_fnc_HQaddObject"",2];"
	#define STR_HQ_HB "closeDialog 0; [""h_barrier"", player] remoteExec [""AS_fnc_HQaddObject"",2];"

	BTN_L(1,-1, "Camo Net", "", STR_HQ_CMO);
	BTN_L(2,-1, "Lantern", "", STR_HQ_LAN);
	BTN_L(3,-1, "Small Bunker", "",STR_HQ_SB);
	BTN_L(4,-1, "H-Barrier", "",STR_HQ_HB);
	...
	BTN_R(3,-1, "Big Bunker", "",STR_HQ_BB);
	BTN_R(4, -1, "Delete All", "", STR_HQ_DEL);
	};
};

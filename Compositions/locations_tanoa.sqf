...
_objects = [
	...
	[AS_big_bunker_type,[59.7285,44.2285,0.00814819],91.8875,1,0,[-0.788925,0.738024],"","",true,false],
...
_objects = [
	...
	[AS_big_bunker_type,[-107.741,-15.7012,0],14.2228,1,0,[0,0],"","",true,false],
	["Land_HBarrier_01_wall_6_green_F",[-174.409,-6.16992,0],200.975,1,0,[0,0],"","",true,false],
	[AS_big_bunker_type,[-156.458,80.3379,0],287.276,1,0,[0,0],"","",true,false],
	...
	[AS_big_bunker_type,[250.988,-38.6201,0],17.6226,1,0,[0,0],"","",true,false],
...
_objects = [
	...
	[AS_big_bunker_type,[-51.0132,-14.439,-0.0283046],41.7974,1,0,[2.97717,1.02237],"","",true,false],
	...
	[AS_big_bunker_type,[-36.0747,43.748,-0.0429125],130.699,1,0,[4.63806,-1.64442],"","",true,false],
...
_objects = [
	...
	[AS_big_bunker_type,[-3.42822,-46.1611,0],46.3481,1,0,[0,0],"","",true,false],
	...
	[AS_big_bunker_type,[-26.145,61.71,0],122.885,1,0,[0,-0],"","",true,false],
	["Land_IRMaskingCover_01_F",[57.353,40.6167,0],258.176,1,0,[0,0],"","",true,false],
	[AS_big_bunker_type,[81.356,24.3491,0],259.246,1,0,[0,0],"","",true,false],
...
_objects = [
	...
	[AS_big_bunker_type,[-10.6338,16.438,-0.3],348.076,1,0,[0,0],"","",true,false],
...
_objects = [
	...
	[AS_big_bunker_type,[16.9961,39.259,0.00864983],172.426,1,0,[-0.717699,2.71413],"","",true,false],
...
_objects = [
	...
	[AS_big_bunker_type,[54.9941,-43.9502,0],126.681,1,0,[0,-0],"","",true,false],
	...
	[AS_big_bunker_type,[48.957,115.054,0.0237188],216.488,1,0,[-2.24155,-1.84899],"","",true,false],
	...
	[AS_big_bunker_type,[-118.631,80.417,0.00690651],126.718,1,0,[-0.446299,3.66477],"","",true,false],

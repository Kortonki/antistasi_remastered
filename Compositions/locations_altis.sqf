...
_objects = [
	...
	[(["CSAT", "static_mortar"] call AS_fnc_getEntity select 0),[11.8877,0.147461,-0.0497971],308.589,1,0,[-2.32635,0.0968218],"","",true,false],
	[(["CSAT", "self_aa"] call AS_fnc_getEntity select 0),[40.3721,-2.87402,0.221872],0.0129312,1,0,[2.82822,-1.83257],"","",true,false],
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[13.3477,7.52344,4.2],149.445,1,0,[0.334842,0.623217],"","",true,false],
	[(["CSAT", "self_aa"] call AS_fnc_getEntity select 0),[-46.1152,-0.722656,0.157579],0.00125647,1,0,[6.39846,-5.78442],"","",true,false],
...
[_dict, "hill_Agela", call DICT_fnc_create] call DICT_fnc_set;
[_dict, "hill_Agela", "center", _center] call DICT_fnc_set;
[_dict, "hill_Agela", "objects", _objects] call DICT_fnc_set;
...
_objects = [
	...
	[(["CSAT", "static_mortar"] call AS_fnc_getEntity select 0),[-8.2832,3.96094,-0.0244293],270.193,1,0,[1.97648,3.59097],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-12.0127,10.4976,-0.0650635],107.983,1,0,[2.13773,-3.79196],"","",true,false],
	...
	[(["CSAT", "self_aa"] call AS_fnc_getEntity select 0),[-21.501,2.0293,0.1150452],230.097,1,0,[-4.53582,7.36498],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[25.6045,-12.6768,-0.094635],190.74,1,0,[-4.54319,-2.83457],"","",true,false],
	...
	[(["CSAT", "static_mortar"] call AS_fnc_getEntity select 0),[35.1787,-1.11279,-0.0185242],267.528,1,0,[2.70742,4.15807],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[43.7568,-12.5303,0.0369415],161.614,1,0,[-15.1426,-3.19791],"","",true,false],
...
[_dict, "hill_Skopos", call DICT_fnc_create] call DICT_fnc_set;
[_dict, "hill_Skopos", "center", _center] call DICT_fnc_set;
[_dict, "hill_Skopos", "objects", _objects] call DICT_fnc_set;
...
_objects = [
	...
	[(["CSAT", "self_aa"] call AS_fnc_getEntity select 0),[7.79785,-2.6084,0.1805359],160.172,1,0,[],"","",true,false],
	...
	[(["CSAT", "self_aa"] call AS_fnc_getEntity select 0),[-10.2705,-10.4375,0.1065918],206.975,1,0,[],"","",true,false],
	...
	[(["CSAT", "self_aa"] call AS_fnc_getEntity select 0),[-12.4941,10.7744,0.211389],307.636,1,0,[],"","",true,false],
	["Land_BagFence_Round_F",[-9.77246,13.4336,0.0517273],212.609,1,0,[],"","",true,false],
	[(["CSAT", "static_mortar"] call AS_fnc_getEntity select 0),[-2.48975,16.4404,-0.0637817],359.987,1,0,[],"","",true,false],
	["Land_BagFence_Round_F",[-12.5127,-11.6875,0.255127],61.8115,1,0,[],"","",true,false],
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[15.7051,-6.46484,-0.0715332],154.878,1,0,[],"","",true,false],
	...
	[(["CSAT", "self_aa"] call AS_fnc_getEntity select 0),[13.4976,12.8945,0.120026],32.7453,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-20.8423,3.3125,-0.0811157],277.828,1,0,[],"","",true,false],
...
[_dict, "hill_Agia Stemma", call DICT_fnc_create] call DICT_fnc_set;
[_dict, "hill_Agia Stemma", "center", _center] call DICT_fnc_set;
[_dict, "hill_Agia Stemma", "objects", _objects] call DICT_fnc_set;

_center = [23697.4,24259.1,0];
_objects = [
	[(["CSAT", "self_aa"] call AS_fnc_getEntity select 0),[-9.03711,-3.94336,0.1341187],58.2242,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mortar"] call AS_fnc_getEntity select 0),[9.29883,-13.6211,-0.0190659],105.47,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_at"] call AS_fnc_getEntity select 0),[-5.48633,-17.9785,-0.0319519],169.841,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[9.41211,18.7109,-0.100784],89.044,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[6.94531,-25.3008,-0.0933228],149.11,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-10.0918,31.7285,-0.0999832],320.862,1,0,[],"","",true,false],
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-29.1035,-16.6934,-0.0705185],227.534,1,0,[],"","",true,false],
...
[_dict, "hill_Agios Andreas", call DICT_fnc_create] call DICT_fnc_set;
[_dict, "hill_Agios Andreas", "center", _center] call DICT_fnc_set;
[_dict, "hill_Agios Andreas", "objects", _objects] call DICT_fnc_set;
...
_objects = [
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-7.91162,8.14063,-0.0396423],302.172,1,0,[],"","",true,false],
	...
	[(["CSAT", "self_aa"] call AS_fnc_getEntity select 0),[-4.07959,-11.2656,0.10253296],310.125,1,0,[],"","",true,false],
	["Land_BagFence_Round_F",[8.78027,8.66016,0.240005],156.911,1,0,[],"","",true,false],
	[(["CSAT", "static_mortar"] call AS_fnc_getEntity select 0),[10.9019,6.96289,-0.0450897],199.846,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_at"] call AS_fnc_getEntity select 0),[18.8398,-5.14453,-0.161438],178.664,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[25.8477,0.640625,-0.0767975],137.089,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-10.9141,-34.2227,-0.0776672],189.415,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[30.48,21.6914,-0.0359802],56.106,1,0,[],"","",true,false],
...
[_dict, "hill_Agios Minas", call DICT_fnc_create] call DICT_fnc_set;
[_dict, "hill_Agios Minas", "center", _center] call DICT_fnc_set;
[_dict, "hill_Agios Minas", "objects", _objects] call DICT_fnc_set;

_center = [7852.7,16664.4,0];
_objects = [
	[(["CSAT", "self_aa"] call AS_fnc_getEntity select 0),[5.31201,0.671875,0.1928345],264.214,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_at"] call AS_fnc_getEntity select 0),[-11.6938,-11.3906,-0.144073],218.973,1,0,[],"","",true,false],
	["Land_BagFence_Short_F",[-13.0547,-9.91016,-0.0939331],308.24,1,0,[],"","",true,false],
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-1.70654,16.7637,-0.113617],359.139,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mortar"] call AS_fnc_getEntity select 0),[22.8213,1.07227,-0.0389557],79.5806,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-22.9595,-5.12891,-0.0215607],211.354,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[26.9902,-10.6387,-0.0621796],125.087,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[32.4355,9.9082,-0.0219574],87.0615,1,0,[],"","",true,false],
...
[_dict, "hill_Amoni", call DICT_fnc_create] call DICT_fnc_set;
[_dict, "hill_Amoni", "center", _center] call DICT_fnc_set;
[_dict, "hill_Amoni", "objects", _objects] call DICT_fnc_set;
...
_objects = [
	...
	[(["CSAT", "self_aa"] call AS_fnc_getEntity select 0),[9.87891,3.35742,0.1560608],236.817,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[9.49023,-11.9385,0.141861],156.8,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-5.58789,16.0273,-0.014389],324.945,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-24.2949,-1.89063,-0.054245],248.599,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mortar"] call AS_fnc_getEntity select 0),[24.2539,15.2344,0.127991],59.6308,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[43.4082,26.4238,-0.0737457],62.6585,1,0,[],"","",true,false],
...
[_dict, "hill_Didymos", call DICT_fnc_create] call DICT_fnc_set;
[_dict, "hill_Didymos", "center", _center] call DICT_fnc_set;
[_dict, "hill_Didymos", "objects", _objects] call DICT_fnc_set;
...
_objects = [
	...
	[(["CSAT", "static_mortar"] call AS_fnc_getEntity select 0),[-0.746094,8.42578,-0.0504761],124.848,1,0,[],"","",true,false],
	...
	[(["CSAT", "self_aa"] call AS_fnc_getEntity select 0),[9.59131,-17.6035,0.11680542],309.994,1,0,[],"","",true,false],
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-1.60498,20.373,-0.085495],338.465,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-29.6631,6.02734,-0.0368195],275.656,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_at"] call AS_fnc_getEntity select 0),[15.6187,-30.9277,-0.136185],170.738,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[25.0874,-30.9648,-0.095871],122.567,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[2.44189,-41.2012,-0.0153961],177.196,1,0,[],"","",true,false],
...
[_dict, "hill_Kira", call DICT_fnc_create] call DICT_fnc_set;
[_dict, "hill_Kira", "center", _center] call DICT_fnc_set;
[_dict, "hill_Kira", "objects", _objects] call DICT_fnc_set;
...
_objects = [
	...
	[(["CSAT", "static_mortar"] call AS_fnc_getEntity select 0),[12.958,0.226563,0.00619507],26.3412,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-17.457,-12.3613,-0.112274],176.463,1,0,[],"","",true,false],
	[(["CSAT", "self_aa"] call AS_fnc_getEntity select 0),[-15.0801,15.2344,0.1490112],60.0282,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[5.17188,23.7754,-0.100067],61.927,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-13.0459,33.7344,-0.0898438],338.361,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-5.42871,-37.5664,-0.00808716],199.151,1,0,[],"","",true,false],
	[(["CSAT", "static_at"] call AS_fnc_getEntity select 0),[-3.39746,-37.8457,-0.0828552],199.462,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[36.3916,-13.2148,-0.0795288],122.189,1,0,[],"","",true,false],
...
[_dict, "hill_Pyrsos", call DICT_fnc_create] call DICT_fnc_set;
[_dict, "hill_Pyrsos", "center", _center] call DICT_fnc_set;
[_dict, "hill_Pyrsos", "objects", _objects] call DICT_fnc_set;

_center = [9213.28,11463.2,0];
_objects = [
	["Land_HBarrier_Big_F",[-1.64063,-7.24121,0],356.835,1,0,[],"","",true,false],
	[(["CSAT", "self_aa"] call AS_fnc_getEntity select 0),[-1.35938,8.79199,0.1558701],177.55,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[10.082,-21.2197,-0.0571747],166.87,1,0,[],"","",true,false],
	[(["CSAT", "static_mortar"] call AS_fnc_getEntity select 0),[-1.18848,23.4795,-0.0384293],354.207,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_at"] call AS_fnc_getEntity select 0),[31.4258,5.01758,-0.13208],84.0392,1,0,[],"","",true,false],
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[31.8467,3.11035,-0.0355072],84.1712,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-30.4297,24.1865,-0.0869064],326.635,1,0,[],"","",true,false],
	[(["CSAT", "static_at"] call AS_fnc_getEntity select 0),[1.41895,38.9414,-0.0702286],3.67325,1,0,[],"","",true,false],
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[3.38867,38.9932,0.00167847],3.24935,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[28.9111,31.6201,-0.0975037],39.4702,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-54.002,-18.5977,0.0522308],250.711,1,0,[],"","",true,false],
	[(["CSAT", "static_at"] call AS_fnc_getEntity select 0),[-53.3838,-20.6738,-0.00646973],252.792,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-75.3594,-11.8398,0.0259094],251.278,1,0,[],"","",true,false],
...
[_dict, "hill_Riga", call DICT_fnc_create] call DICT_fnc_set;
[_dict, "hill_Riga", "center", _center] call DICT_fnc_set;
[_dict, "hill_Riga", "objects", _objects] call DICT_fnc_set;

_center = [6528.61,21627,0];
_objects = [
	["Land_HBarrier_Big_F",[5.31445,0.896484,-0.000732422],275.082,1,0,[],"","",true,false],
	[(["CSAT", "self_aa"] call AS_fnc_getEntity select 0),[-7.12646,1.21875,0.1325012],95.5878,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-11.1553,14.8105,-0.0447388],0.381093,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_at"] call AS_fnc_getEntity select 0),[-13.1431,14.7207,-0.148895],3.58366,1,0,[],"","",true,false],
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[19.1421,-6.12109,-0.0855408],117.08,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mortar"] call AS_fnc_getEntity select 0),[-21.0576,4.63281,-0.0133972],266.15,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-16.2104,-14.9004,0.0392151],208.793,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-35.3613,5.1543,-0.0903015],264.788,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_at"] call AS_fnc_getEntity select 0),[27.022,-25.9336,-0.161133],199.888,1,0,[],"","",true,false],
...
[_dict, "hill_Synneforos", call DICT_fnc_create] call DICT_fnc_set;
[_dict, "hill_Synneforos", "center", _center] call DICT_fnc_set;
[_dict, "hill_Synneforos", "objects", _objects] call DICT_fnc_set;
...
_objects = [
	...
	[(["CSAT", "self_aa"] call AS_fnc_getEntity select 0),[20.2227,8.07813,0.155603],321.664,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[24.1064,-8.66016,-0.0745544],265.743,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[10.6099,-28.1543,-0.019165],177.652,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_at"] call AS_fnc_getEntity select 0),[-17.2964,38.1328,-0.13913],101.556,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_at"] call AS_fnc_getEntity select 0),[-36.1826,36.3477,-0.125916],222.578,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[57.1069,-10.457,-0.0308533],89.3368,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mortar"] call AS_fnc_getEntity select 0),[-58.6455,20.3984,-0.036438],206.534,1,0,[],"","",true,false],
	...
	[(["CSAT", "static_mg"] call AS_fnc_getEntity select 0),[-17.124,61.9551,-0.0612183],61.6532,1,0,[],"","",true,false],
...
[_dict, "hill_Thronos", call DICT_fnc_create] call DICT_fnc_set;
[_dict, "hill_Thronos", "center", _center] call DICT_fnc_set;
[_dict, "hill_Thronos", "objects", _objects] call DICT_fnc_set;

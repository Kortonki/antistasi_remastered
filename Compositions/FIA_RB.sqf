...
fnc_RB_placeSingle = {
	params [["_position", [0,0,0]], ["_lane", "right"]];
	...
	//[_gunner, false] remoteExecCall ["AS_fnc_initUnitFIA", _gunner];// these functions are only called by `createFIApuestos2`, which are responsible for undoing this call.
...
publicVariable "fnc_RB_placeDouble";
publicVariable "fnc_RB_placeSingle";
publicVariable "FIA_RB1_1";
publicVariable "FIA_RB1_2";
publicVariable "FIA_RB2_1";
publicVariable "FIA_RB2_2";
publicVariable "FIA_RB3_1";
publicVariable "FIA_RB3_2";
publicVariable "fnc_RB_randomRB";

...
if (_missionType == "steal_ammo") exitWith {
    [AS_mission_stealTruck_states, AS_mission_stealTruck_state_functions]
};
if (_missionType == "steal_fuel") exitWith {
    [AS_mission_stealTruck_states, AS_mission_stealTruck_state_functions]
};
...
if (_missionType in ["convoy_armor", "convoy_ammo", "convoy_prisoners", "convoy_hvt", "convoy_money", "convoy_supplies", "convoy_fuel"]) exitWith {

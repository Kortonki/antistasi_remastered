...
if (_startHr == -1) then {_startHr = round(100*((random 1)^2.32))};
if (_startMoney == -1) then {_startMoney = round(20000*((random 1)^3.32))};
...
AS_Pset("minAISkill",0.2); // The minimum skill of the AAF/FIA AI (at lowest skill level)

...
{
	diag_log format ["UPSMON: Area marker not defined.\n(Typo, or name not enclosed in quotation marks?) Marker: %1, Group side: %2, Group type: %3, grpid: %4", _areamarker, _side, _grptype, _grpid];
};

...
switch _type do {
	...
	case "interrogate": {_object addAction [localize "STR_act_interrogate", AS_actions_fnc_interrogate,nil,0,false,true,"",IS_PLAYER]};
	case "offerToJoin": {_object addAction [localize "STR_act_offerToJoin", AS_actions_offerToJoin,nil,0,false,true,"",IS_PLAYER]};
	...
	case "jam": {_object addAction [localize "STR_act_jamCSAT", AS_actions_fnc_jamLRRadio,nil,0,false,true,"","true"]};
	...
	case "repackMagazines" : {_object addAction [localize "STR_act_repack", AS_actions_fnc_repackMagazines,nil,0,false,true,"","true"]};
	...
	case "unloadCargo" : {_object addAction [localize "STR_act_unloadBoxCargo", AS_actions_fnc_unloadCargo,nil,0,false,true,"","true", 10]};
	case "radio" : {_object addAction [localize "STR_act_radio", AS_actions_fnc_radio,nil,0,false,true,"","true", 4]};
	case "build_camp" : {_object addAction [localize "STR_act_buildCamp", {[_this select 0, _this select 1] remoteExec ["AS_fnc_buildCamp", 2]},nil,0,false,true,"true"]};
	case "build_roadblock" : {_object addAction [localize "STR_act_buildRoadblock", {[_this select 0, _this select 1] remoteExec ["AS_fnc_buildRoadblock", 2]},nil,0,false,true,"true"]};
	case "build_watchpost" : {_object addAction [localize "STR_act_buildWatchpost", {[_this select 0, _this select 1] remoteExec ["AS_fnc_buildWatchpost", 2]},nil,0,false,true,"true"]};
	default {

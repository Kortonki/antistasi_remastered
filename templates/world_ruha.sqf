...
[200,300,["Joutkallio","Korpi","Kivimäki","Kortesoja", "Kumuri", "Mäkelä","Martikkalankylä","Virpimäki","Huhtamäki", "Hipinmäki", "Metsälä office", "Järvelä", "Länsikylä sawmill", "Tervasmäki", "Varjo Hotel", "Vuorenmaanloukko"]] call AS_location_fnc_addCities;

...
[100,100, 1000,["Joutkallio","Korpi","Kivimäki","Kortesoja", "Kumuri", "Mäkelä","Martikkalankylä","Virpimäki","Huhtamäki", "Hipinmäki", "Metsälä office", "Järvelä", "Länsikylä sawmill", "Tervasmäki", "Varjo Hotel"]] call AS_location_fnc_addCities;

...
[200, 200, 1000, ["Ipota", "Tuvanaka", "Belfort", "Nani", "Balavu", "Leqa", "Muaceba", "Tavu", "Laikoro", "Namuvaka", "Rautake",
            "Savaka", "Katkoula", "Lailai", "Yanukka", "Cerebu", "Koumac", "Blue Pearl industrial port", "Vatukoulo"]] call AS_location_fnc_addCities;

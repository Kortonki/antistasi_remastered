...
if (_killed in AS_P("vehicles")) then {
	diag_log format ["Persistent vehicle deleted via AS_fnc_activateVehicleCleanup. Vehicle %1, location %2", _killed, (position _killed) call AS_location_fnc_nerest];

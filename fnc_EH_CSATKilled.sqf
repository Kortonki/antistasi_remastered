...
if (isNil{["FIRSTBLOOD_date"] call AS_stats_fnc_get} and {_killer call AS_fnc_getSide == "FIA"}) then {
...
if (isNil{["NATO_killCSAT_date"] call AS_stats_fnc_get} and {_killer call AS_fnc_getSide == "NATO"}) then {
	["NATO_killCSAT_date", date] call AS_stats_fnc_set;
};

if (isNil{["FIA_killCSAT_date"] call AS_stats_fnc_get} and {_killer call AS_fnc_getSide == "FIA"}) then {

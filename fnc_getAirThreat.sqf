...
_threatMod = AS_P("threatEval_Air_mod");

diag_log format ["[AS] getairThreat: Position: %1 near %2 EnemySide: %3 AirThreat: %4 modifier: %5", _position, [call AS_location_fnc_cities, _position] call bis_fnc_nearestPosition, _enemySide, _threat, _threatMod];

...

{
	...
	call {
				if (_buildingType in ["Land_Cargo_HQ_V1_F", "Land_Cargo_HQ_V2_F", "Land_Cargo_HQ_V3_F"]) exitWith {
				...
				if (_buildingType in ["Land_Cargo_Patrol_V1_F", "Land_Cargo_Patrol_V2_F", "Land_Cargo_Patrol_V3_F"]) exitWith {
				...
				if (_buildingType in ["Land_Cargo_Tower_V1_F", "Land_Cargo_Tower_V2_F", "Land_Cargo_Tower_V3_F"]) exitWith {
			...
			private _veh = createVehicle [_staticMG, getpos _building, [], 0, "CAN_COLLIDE"];
			private _unit = _grupo createUnit [_gunnerCrew, _posicion, [], 0, "NONE"];
			_unit moveInGunner _veh;
			_soldiers pushback _unit;
			_vehicles pushback _veh;

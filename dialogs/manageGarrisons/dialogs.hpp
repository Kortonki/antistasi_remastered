class AS_manageGarrisons
{
	...
	class controls
	{
AS_DIALOG(5,"Manage garrison", "closeDialog 0; call AS_fnc_UI_manageHQ_menu; if (not(isNil ""garrisonUpdated"")) then {[map_location] spawn AS_location_fnc_respawnGarrison; map_location = nil; garrisonUpdate = nil;};");

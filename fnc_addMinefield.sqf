...
private _mrk = createMarker [format ["FIAmines_%1_%2", call AS_fnc_uniqueID, _position call AS_location_fnc_nearest], _position];
...
if (_minesData isEqualTo [] and {_side != "FIA"}) then {
